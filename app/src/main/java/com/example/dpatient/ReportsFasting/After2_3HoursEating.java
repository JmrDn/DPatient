...
import com.example.dpatient.ReportsFasting.After2_3HoursReports.MyViewPagerAdapterAfter2_3hrsEatingReports;
...
public class After2_3HoursEating extends Fragment {
    private MyViewPagerAdapterAfter2_3hrsEatingReports myViewPagerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_after2_3_hours_eating, container, false);
        initWidgets(view);
        setUpAllOverData();

        myViewPagerAdapter = new MyViewPagerAdapterAfter2_3hrsEatingReports(getActivity());
                            ...
                            if (task.isSuccessful()){
                                ...
                                if (documentSnapshot.exists()){
                                    if (documentSnapshot.contains("after_2_3_hours_average") &&
                                        ...
                                        long fastingGlucoseAverage = documentSnapshot.getLong("after_2_3_hours_average");
                                        long fastingHighestGlucose = documentSnapshot.getLong("after_2_3_hours_highest");
                                        long fastingLowestGlucose = documentSnapshot.getLong("after_2_3_hours_lowest");
    ...
    private void initWidgets(View view) {
        ...
        viewPager2 = view.findViewById(R.id.after2_3hrs_ViewPager2);
        tabLayout = view.findViewById(R.id.after2_3hrs_TabLayout);
    }
}