...
public class After2_3HoursMonthlyReports extends Fragment {
   ...
   private FrameLayout noDataFrameLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_after2_3_hours_monthly_reports, container, false);
                                    ...
                                    if (!querySnapshot.isEmpty() && querySnapshot != null){
                                        ...
                                        for (QueryDocumentSnapshot documentSnapshot: task.getResult()){
                                            if (documentSnapshot.contains("after_2_3_hours_average")){
                                                ...
                                                long glucoseMonthAverage = documentSnapshot.getLong("after_2_3_hours_average");
