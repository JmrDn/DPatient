...
public class AfterEatingMonthlyReports extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_after_eating_monthly_reports, container, false);
                                    ...
                                    if (!querySnapshot.isEmpty() && querySnapshot != null){
                                        ...
                                        for (QueryDocumentSnapshot documentSnapshot: task.getResult()){
                                            if (documentSnapshot.contains("after_eating_average")){
                                                ...
                                                long glucoseMonthAverage = documentSnapshot.getLong("after_eating_average");
