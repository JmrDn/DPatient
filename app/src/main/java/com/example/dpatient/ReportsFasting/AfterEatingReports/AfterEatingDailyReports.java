...
public class AfterEatingDailyReports extends Fragment implements CalendarAdapter.OnItemListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_after_eating_daily_reports, container, false);
                                    ...
                                    for (DocumentSnapshot documentSnapshot: task.getResult()){
                                        if (documentSnapshot.exists()){
                                            if(documentSnapshot.contains("fasting")){
                                                ...
                                                if (fasting.equals("After Eating")){
